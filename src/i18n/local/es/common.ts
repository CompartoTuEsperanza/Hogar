const es = {
  ...
  manifesto_historia: "Existe un Perú profundo que late con fuerza en el silencio de sus montañas. Allí, en los valles del Cusco, agricultores que el sistema olvidó cuidan con devoción el café Chuncho Orgánico, sanando una tierra golpeada por el abandono y los precios injustos. Estos productores son el alma de la resistencia; hombres y familias campesinas que se levantaron con puro coraje frente a promesas vacías e intermediarios que los explotaron. Con el viento en contra y sin un Estado que los respalde, decidieron no rendirse, transformando el dolor en orgullo y eligiendo la dignidad como el único camino para proteger sus raíces. COMPARTO_TU_ESPERANZA es el abrazo que une esa valentía incansable contigo. Creamos este puente para que, al otro lado del océano, cada onza de chocolate que pruebes deje de ser un simple placer y se convierta en un abrazo de vuelta, en una inversión real en la vida de quienes lo dan todo por su tierra. Elegir este Café de Especialidad no es solo un asunto de buen gusto; es mirarlos a los ojos, reconocer su valor y comprometerse con la reconstrucción de un legado sagrado que ellos, contra todo pronóstico, decidieron salvar.",
  ...
  // Footer
  footer_tagline: "Café de Especialidad del Cusco,\nPerú.",
  ...
  vision_card1_body: "Convertir al Café de Especialidad del Cusco en el referente de calidad e impacto social más reconocido a nivel internacional, logrando que cada productor sea protagonista de su propio éxito y exporte su historia al mundo. Para lograrlo, como la gran familia que somos, adoptaremos juntos los cuidados y normas que la Unión Europea nos pide, garantizando que nuestro café Chuncho Orgánico sea impecable y único en el extranjero.",
  vision_card2_title: "Nuestro Centro de Acopio",
  vision_card2_body: "En esta gran familia unida y próspera, construiremos juntos nuestro propio centro de acopio para lograr una fermentación y un aroma superiores que demuestren que en nuestra tierra se produce el mejor Café de Especialidad del Perú.",
  vision_card3_title: "Del Grano al Chocolate",
  vision_card3_body: "Lograremos expandir nuestros horizontes hasta transformar nuestro Café de Especialidad en chocolate propio, multiplicando los frutos de este gran proyecto donde ambos nos arriesgamos, apostando nuestro tiempo, dinero y confianza mutua desde el primer día. Seremos el motor que transformará la vida en Cusco, demostrando que cuando una familia cree, se la juega el uno por el otro y camina unida, los sueños más grandes se hacen realidad y el bienestar llega para quedarse para siempre en cada hogar.",
  process_step1_title: "Cultivo",
  process_step1_subtitle: "Café de Especialidad nativo de altura",
  process_step1_desc: "Café de Especialidad nativo cultivado en altitudes de 800-1200m en los valles del Cusco.",
  process_step1_tag1: "Café de Especialidad",
  ...
  historia_cards3: [
    "Nació porque también entendí algo fundamental: ayudar no significa regalar. Ayudar significa crear oportunidades sostenibles y reales. Significa mostrarle al mundo el verdadero valor de nuestros agricultores, de nuestro Café de Especialidad, de nuestra cultura y del trabajo extraordinario que existe en el Perú.",
    ...
    "Hoy ese camino ya empezó a abrirse. Ya existen contactos y clientes en Europa interesados en Café de Especialidad peruano de alta calidad. Y gracias a nuestra presencia en República Checa, podemos asegurar procesos, calidad y distribución hacia distintos países de Europa.",
    ...
    "Sueño con ver a nuestros productores reconocidos internacionalmente. Sueño con que el mundo conozca la calidad extraordinaria del Café de Especialidad peruano y, sobre todo, las historias humanas que existen detrás de cada producto. Porque esto no se trata de lástima. Se trata de dignidad. La ONG cuida a las familias. La empresa cuida su trabajo y su futuro económico. Una protege el corazón de las personas. La otra abre las puertas para que puedan crecer con independencia, orgullo y oportunidades reales. Porque al final, mi sueño nunca fue simplemente exportar productos. Mi sueño siempre fue cambiar vidas. Y hoy quiero hacerlo junto a ustedes."
  ],
  nav_about: "Nosotros",
  ...
  unidos_cards: [
    "Quiero que juntos construyamos algo mucho más grande que una empresa. Quiero que, junto a ustedes — nuestros productores de Café de Especialidad del Cusco — nos convirtamos en una gran familia. Una familia unida por el trabajo, el respeto, la confianza y el sueño de llevar al mundo uno de los tesoros más valiosos de nuestra tierra: el Café de Especialidad del Perú.",
    "Sueño con el día en que nuestro Café de Especialidad sea reconocido internacionalmente no solo por su calidad extraordinaria, sino también por su aroma inigualable, su origen único y la historia humana que existe detrás de cada cosecha. Pero, sobre todo, sueño con que cada uno de ustedes sea reconocido. Reconocido por sus años de esfuerzo. Por el amor que ponen en cada planta. Por las madrugadas de trabajo. Por la dedicación silenciosa que durante mucho tiempo nadie vio ni valoró como merecía.",
    "Porque detrás del mejor café no solo hay tierra fértil. Hay familias. Hay sacrificios. Hay historia. Hay corazón. Y eso es lo que quiero mostrarle al mundo.",
