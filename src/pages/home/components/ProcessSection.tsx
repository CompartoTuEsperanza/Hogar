              ...
              >
                ...
                >
                  <div className="flex flex-col gap-2">
                    ...
                    <h3 className="text-cream text-base leading-tight writing-vertical">
                      {step.title}
                    </h3>
                  </div>
                </div>
                ...
                >
                  ...
                  <h3 className="text-cream text-2xl md:text-3xl leading-tight mb-3">
                    {step.title}
                  </h3>
            ...
            <div key={step.n} className="relative rounded-2xl overflow-hidden h-[220px]">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between p-5">
                ...
                <div>
                  ...
                  <h3 className="text-cream text-xl leading-tight mb-2">{step.title}</h3>
