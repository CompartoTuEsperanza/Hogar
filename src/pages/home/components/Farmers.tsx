  ...
  return (
    <section id="farmers" className="relative w-full bg-coffee-900 overflow-hidden py-10 md:py-12">
      <video autoPlay muted loop playsInline
        ...
        src="/Hogar/videos/farmers-bg.mp4"
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-20 lg:pl-32 lg:pr-12">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl md:text-4xl text-cream font-black mb-2 uppercase" style={{ fontFamily: "'Josefin Sans', sans-serif" }}>{t('farmers_title')}</h2>
